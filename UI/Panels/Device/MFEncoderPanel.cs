...
namespace MobiFlight.UI.Panels.Settings.Device
{
    public partial class MFEncoderPanel : UserControl
    {
        ...
        private void ReassignFreePinsInDropDowns(ComboBox comboBox)
        {
            ...
            if (comboBox == mfLeftPinComboBox) { ComboBoxHelper.reassignChannelPin(mfLeftPinComboBox, pinList, ref encoder.PinLeft, ref encoder.PinLeftSel); } 
            else
            if (comboBox == mfRightPinComboBox) { ComboBoxHelper.reassignChannelPin(mfRightPinComboBox, pinList, ref encoder.PinRight, ref encoder.PinRightSel); }
